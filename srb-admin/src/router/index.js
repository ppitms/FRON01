...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        meta: { title: "积分等级列表", icon: "el-icon-s-order" },
      },
      {
        path: "create",
        name: "coreIntegralGradeCreate",
        component: () => import("@/views/core/integral-grade/form"),
        meta: { title: "新增积分等级", icon: "el-icon-plus" },
      },
      {
        path: "edit/:id",
        name: "coreIntegralGradeEdit",
        component: () => import("@/views/core/integral-grade/form"),
        meta: { title: "修改积分等级", icon: "el-icon-edit" },
        hidden: true,
      },
    ],
  },
    ...
    children: [
      {
        ...
        meta: { title: "借款等级列表", icon: "el-icon-s-order" },
      },
      {
        path: "detail/:id",
      ...
      },
      {
        ...
        meta: { title: "借款列表", icon: "el-icon-s-order" },
      },
      {
        path: "info-detail/:id",
  ...
  },
  {
    ...
    name: "coreLend",
    meta: { title: "标的管理", icon: "el-icon-user-solid" },
    alwaysShow: true,
    children: [
      {
        path: "list",
        ...
        meta: { title: "标的列表", icon: "el-icon-s-order" },
      },
      {
        path: "detail/:id",
        name: "coreLendDetail",
        component: () => import("@/views/core/lend/detail"),
        meta: { title: "标的详情", icon: "el-icon-s-grid" },
        hidden: true,
      },
    ],
  },
    ...
    children: [
      {
        ...
        meta: { title: "数据字典列表", icon: "el-icon-s-order" },
      },
    ],
  },
  {
